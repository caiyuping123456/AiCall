    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/doctor/auth/login").permitAll()
                .requestMatchers("/doctor/auth/logout").authenticated()
                ...
                .requestMatchers("/user/doctors/**").permitAll()
                .requestMatchers("/user/registration/**").authenticated()
